  ...
  hideMenuModal() {
    return <Modal
      ...
      <View style={styles.modal}>
        ...
        >
          <Text style={styles.modalItem}>Установить будильник</Text>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          <Text style={styles.modalItem}>Предложить радиостанцию</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.modalView}
          onPress={() => {
        ...
        >
          <Text style={styles.modalItem}>Оставить отзыв</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.modalView}
          onPress={() => {
        ...
        >
          <Text style={styles.modalItem}>Настройки</Text>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          <Text style={styles.modalItem}>Выход</Text>
        </TouchableOpacity>
      </View>
    </Modal>
  }
